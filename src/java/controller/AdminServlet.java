...
import session.UserOrderFacade;
...
public class AdminServlet extends HttpServlet { 
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userPath.equals("/admin/customerRecord")) {
            ...
            User = UserFacade.find(Integer.parseInt(customerId));
            request.setAttribute("customerRecord", User);

            // get customer order details
            UserOrder = UserOrderFacade.findByUser(User);
        ...
        if (userPath.equals("/admin/logout")) {
            ...
            response.sendRedirect("/AffableBean_Test_Bootstrap/admin/");
            return;
        }
