...
public class ShoppingCart {
     ...
     */
    public synchronized void addItem(Product product) { //TODO: very important for marks

        boolean newItem = true;

        for (ShoppingCartItem scItem : items) {

            if (scItem.getProduct().getProductid().intValue() == product.getProductid().intValue()) {
